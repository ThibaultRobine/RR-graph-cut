...
#include "C:\Users\aejog\Documents\Info\IO_PNG\include\zlib\zlib.h"
...
int main2(int argc, char* argv[]) {
    ...
    cout << '1'<<endl;
    unsigned char * IM1 = io_png_read_u8("face0.png", nxp,nyp,ncp);
    cout << '2'<<endl;
    io_png_write_u8("img_test.png",IM1, *nxp,*nyp,*ncp);
    cout << '3'<<endl;
    click();
    if(argc!=1 && argc!=5) {
